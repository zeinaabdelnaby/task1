...
class _HospitalsScreenState extends State<HospitalsScreen> {
  void initState() {
    BlocProvider.of<HospitalsCubit>(context).getHospitalsData();
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<HospitalsCubit, HospitalsState>(
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (_, index) =>  CustomStack2(
                         resource:
                                        cubit.hospitalsModel?.resource![index],
                      ),
                      itemCount: cubit.hospitalsModel?.resource!.length,
                    ),
                  )
                ],
              ),
