...
class CustomStack2 extends StatelessWidget {
  const CustomStack2({super.key, required this.index});
  final int index;
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        HospitalCubit.get(context).getHospitalData();
        GoRouter.of(context).push(AppRouters.kinfoHospitalScreen, extra: index);
      },
      child: Padding(
